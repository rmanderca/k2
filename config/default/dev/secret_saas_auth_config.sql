...
create or replace package saas_auth_config as 
   ...
   saas_auth_domain varchar2(120) := 'xxxxxxxxxxxxxxxxxxx.adb.us-phoenix-1.oraclecloudapps.com';
   ...
   verify_email_redirect varchar2(100) := 'home';
   verify_email_expire_minutes number := 60;
   forgot_pass_redirect varchar(100) := 'change-pass';
