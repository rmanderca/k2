...
create or replace package saas_auth_config as 
   ...
   saas_auth_salt varchar2(120) := 'Monkey jump cloud kick up dust mop.';
   saas_auth_test_pass varchar2(120) := 'k2ERPokk3n$';

   -- Prevent users from creating account unless thier passwords start with this secret prefix.
   saas_auth_pass_prefix varchar2(120) := 'r2d2';
   ...
   global_email_override varchar2(120) := 'post.ethan@gmail.com';
