...
function make_buttons_large() {
  // Ignore the sort desc and acs buttons in IG column headers.
...
The purpose of this function is to retrieve the primary key values of the selected/checked rows in the Interactive Grid and return them as a delimited string. 

Credit: https://blog.cloudnueva.com/apex-ig-processing-selected-records

*/

k2.IGSelectedKeys = function  (IGStaticId) {
